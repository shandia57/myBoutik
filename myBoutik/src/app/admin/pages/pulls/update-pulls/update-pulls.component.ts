...
@Component({
  selector: 'app-update-pulls',
  templateUrl: './update-pulls.component.html',
  styleUrls: ['./update-pulls.component.scss']
})
export class UpdatePullsComponent implements OnInit {
